function join_with_shared_prefix(a, b, joiner) {
  ...
  return a.slice(0, i) + a.slice(i) + joiner + b.slice(0);
}
...
module.exports = require("../template")({
  ...
  /* Capitalize the first letter of every word, that is longer than two letters
   * (This is probably a very crude bastardization of proper Portuguese titling
